function [props, fig, figname] = t2n_APprop_marius(targetfolder_data,neuron,currstep,tree,askfile) %,dataset
...
if any(uu==2)
    if askfile
        ...
        sim1 = load(t2n_catName(targetfolder_data,'Exp_Spiking',neuron.experiment));%robust %fixed dt raus
    end
end
