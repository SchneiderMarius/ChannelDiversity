...
if ~isempty(targetfolder_results)
    if isfield(ostruct,'savename') && ~isempty(ostruct.savename)
        ...
        tprint(t2n_catName(targetfolder_results,'Fig3-FI',neuron.experiment),'-jpg');
    end
end
...
if ~isempty(targetfolder_results)
    if isfield(ostruct,'savename')  && ~isempty(ostruct.savename)
        if ~isempty(ostruct.savename)
            tprint(fullfile(targetfolder_results,[ostruct.savename,'_Hz']),'-jpg');
        end
    else
        tprint(t2n_catName(targetfolder_results,'Fig3-FI_Hz',neuron.experiment),'-jpg');
    end
end