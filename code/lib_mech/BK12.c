...
#define nrn_init _nrn_init__BK12
#define _nrn_initial _nrn_initial__BK12
#define nrn_cur _nrn_cur__BK12
#define _nrn_current _nrn_current__BK12
#define nrn_jacob _nrn_jacob__BK12
#define nrn_state _nrn_state__BK12
#define _net_receive _net_receive__BK12 
#define rates rates__BK12 
#define state state__BK12 
...
extern Memb_func* memb_func;
 ...
 "setdata_BK12", _hoc_setdata,
 "peakab_BK12", _hoc_peakab,
 "peaka_BK12", _hoc_peaka,
 "rates_BK12", _hoc_rates,
 "shiftab_BK12", _hoc_shiftab,
 "shifta_BK12", _hoc_shifta,
 "taufunc_BK12", _hoc_taufunc,
 0, 0
};
#define peakab peakab_BK12
#define peaka peaka_BK12
#define shiftab shiftab_BK12
#define shifta shifta_BK12
#define taufunc taufunc_BK12
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 BK12 C:/Scan/lib_mech/BK12.mod\n");
