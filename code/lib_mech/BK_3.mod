: Ca-dependent K channels (BK_3) - alphabeta4 and alpha
...
DERIVATIVE state {
	...
	acai = (ncai) / diff : instantaneous calcium concentration of N-type Ca channels for BK_3 activation modified by diffusion factor for nanodomains
