...
#define nrn_init _nrn_init__BK10
#define _nrn_initial _nrn_initial__BK10
#define nrn_cur _nrn_cur__BK10
#define _nrn_current _nrn_current__BK10
#define nrn_jacob _nrn_jacob__BK10
#define nrn_state _nrn_state__BK10
#define _net_receive _net_receive__BK10 
#define rates rates__BK10 
#define state state__BK10 
...
extern Memb_func* memb_func;
 ...
 "setdata_BK10", _hoc_setdata,
 "peakab_BK10", _hoc_peakab,
 "peaka_BK10", _hoc_peaka,
 "rates_BK10", _hoc_rates,
 "shiftab_BK10", _hoc_shiftab,
 "shifta_BK10", _hoc_shifta,
 "taufunc_BK10", _hoc_taufunc,
 0, 0
};
#define peakab peakab_BK10
#define peaka peaka_BK10
#define shiftab shiftab_BK10
#define shifta shifta_BK10
#define taufunc taufunc_BK10
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 BK10 C:/Scan/lib_mech/BK10.mod\n");
