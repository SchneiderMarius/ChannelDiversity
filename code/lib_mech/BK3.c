...
#define nrn_init _nrn_init__BK3
#define _nrn_initial _nrn_initial__BK3
#define nrn_cur _nrn_cur__BK3
#define _nrn_current _nrn_current__BK3
#define nrn_jacob _nrn_jacob__BK3
#define nrn_state _nrn_state__BK3
#define _net_receive _net_receive__BK3 
#define rates rates__BK3 
#define state state__BK3 
...
extern Memb_func* memb_func;
 ...
 "setdata_BK3", _hoc_setdata,
 "peakab_BK3", _hoc_peakab,
 "peaka_BK3", _hoc_peaka,
 "rates_BK3", _hoc_rates,
 "shiftab_BK3", _hoc_shiftab,
 "shifta_BK3", _hoc_shifta,
 "taufunc_BK3", _hoc_taufunc,
 0, 0
};
#define peakab peakab_BK3
#define peaka peaka_BK3
#define shiftab shiftab_BK3
#define shifta shifta_BK3
#define taufunc taufunc_BK3
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 BK3 C:/Scan/lib_mech/BK3.mod\n");
