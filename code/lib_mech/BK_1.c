...
#define nrn_init _nrn_init__BK_1
#define _nrn_initial _nrn_initial__BK_1
#define nrn_cur _nrn_cur__BK_1
#define _nrn_current _nrn_current__BK_1
#define nrn_jacob _nrn_jacob__BK_1
#define nrn_state _nrn_state__BK_1
#define _net_receive _net_receive__BK_1 
#define rates rates__BK_1 
#define state state__BK_1 
...
extern Memb_func* memb_func;
 ...
 "setdata_BK_1", _hoc_setdata,
 "peakab_BK_1", _hoc_peakab,
 "peaka_BK_1", _hoc_peaka,
 "rates_BK_1", _hoc_rates,
 "shiftab_BK_1", _hoc_shiftab,
 "shifta_BK_1", _hoc_shifta,
 "taufunc_BK_1", _hoc_taufunc,
 0, 0
};
#define peakab peakab_BK_1
#define peaka peaka_BK_1
#define shiftab shiftab_BK_1
#define shifta shifta_BK_1
#define taufunc taufunc_BK_1
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 BK_1 C:/Scan/lib_mech/BK_1.mod\n");
