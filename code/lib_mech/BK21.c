...
#define nrn_init _nrn_init__BK21
#define _nrn_initial _nrn_initial__BK21
#define nrn_cur _nrn_cur__BK21
#define _nrn_current _nrn_current__BK21
#define nrn_jacob _nrn_jacob__BK21
#define nrn_state _nrn_state__BK21
#define _net_receive _net_receive__BK21 
#define rates rates__BK21 
#define state state__BK21 
...
extern Memb_func* memb_func;
 ...
 "setdata_BK21", _hoc_setdata,
 "peakab_BK21", _hoc_peakab,
 "peaka_BK21", _hoc_peaka,
 "rates_BK21", _hoc_rates,
 "shiftab_BK21", _hoc_shiftab,
 "shifta_BK21", _hoc_shifta,
 "taufunc_BK21", _hoc_taufunc,
 0, 0
};
#define peakab peakab_BK21
#define peaka peaka_BK21
#define shiftab shiftab_BK21
#define shifta shifta_BK21
#define taufunc taufunc_BK21
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 BK21 C:/Scan/lib_mech/BK21.mod\n");
