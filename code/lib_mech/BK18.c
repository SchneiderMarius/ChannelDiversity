...
#define nrn_init _nrn_init__BK18
#define _nrn_initial _nrn_initial__BK18
#define nrn_cur _nrn_cur__BK18
#define _nrn_current _nrn_current__BK18
#define nrn_jacob _nrn_jacob__BK18
#define nrn_state _nrn_state__BK18
#define _net_receive _net_receive__BK18 
#define rates rates__BK18 
#define state state__BK18 
...
extern Memb_func* memb_func;
 ...
 "setdata_BK18", _hoc_setdata,
 "peakab_BK18", _hoc_peakab,
 "peaka_BK18", _hoc_peaka,
 "rates_BK18", _hoc_rates,
 "shiftab_BK18", _hoc_shiftab,
 "shifta_BK18", _hoc_shifta,
 "taufunc_BK18", _hoc_taufunc,
 0, 0
};
#define peakab peakab_BK18
#define peaka peaka_BK18
#define shiftab shiftab_BK18
#define shifta shifta_BK18
#define taufunc taufunc_BK18
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 BK18 C:/Scan/lib_mech/BK18.mod\n");
