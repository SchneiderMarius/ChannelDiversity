...
#define nrn_init _nrn_init__BK16
#define _nrn_initial _nrn_initial__BK16
#define nrn_cur _nrn_cur__BK16
#define _nrn_current _nrn_current__BK16
#define nrn_jacob _nrn_jacob__BK16
#define nrn_state _nrn_state__BK16
#define _net_receive _net_receive__BK16 
#define rates rates__BK16 
#define state state__BK16 
...
extern Memb_func* memb_func;
 ...
 "setdata_BK16", _hoc_setdata,
 "peakab_BK16", _hoc_peakab,
 "peaka_BK16", _hoc_peaka,
 "rates_BK16", _hoc_rates,
 "shiftab_BK16", _hoc_shiftab,
 "shifta_BK16", _hoc_shifta,
 "taufunc_BK16", _hoc_taufunc,
 0, 0
};
#define peakab peakab_BK16
#define peaka peaka_BK16
#define shiftab shiftab_BK16
#define shifta shifta_BK16
#define taufunc taufunc_BK16
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 BK16 C:/Scan/lib_mech/BK16.mod\n");
