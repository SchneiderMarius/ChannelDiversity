...
#define nrn_init _nrn_init__BK20
#define _nrn_initial _nrn_initial__BK20
#define nrn_cur _nrn_cur__BK20
#define _nrn_current _nrn_current__BK20
#define nrn_jacob _nrn_jacob__BK20
#define nrn_state _nrn_state__BK20
#define _net_receive _net_receive__BK20 
#define rates rates__BK20 
#define state state__BK20 
...
extern Memb_func* memb_func;
 ...
 "setdata_BK20", _hoc_setdata,
 "peakab_BK20", _hoc_peakab,
 "peaka_BK20", _hoc_peaka,
 "rates_BK20", _hoc_rates,
 "shiftab_BK20", _hoc_shiftab,
 "shifta_BK20", _hoc_shifta,
 "taufunc_BK20", _hoc_taufunc,
 0, 0
};
#define peakab peakab_BK20
#define peaka peaka_BK20
#define shiftab shiftab_BK20
#define shifta shifta_BK20
#define taufunc taufunc_BK20
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 BK20 C:/Scan/lib_mech/BK20.mod\n");
