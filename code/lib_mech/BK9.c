...
#define nrn_init _nrn_init__BK9
#define _nrn_initial _nrn_initial__BK9
#define nrn_cur _nrn_cur__BK9
#define _nrn_current _nrn_current__BK9
#define nrn_jacob _nrn_jacob__BK9
#define nrn_state _nrn_state__BK9
#define _net_receive _net_receive__BK9 
#define rates rates__BK9 
#define state state__BK9 
...
extern Memb_func* memb_func;
 ...
 "setdata_BK9", _hoc_setdata,
 "peakab_BK9", _hoc_peakab,
 "peaka_BK9", _hoc_peaka,
 "rates_BK9", _hoc_rates,
 "shiftab_BK9", _hoc_shiftab,
 "shifta_BK9", _hoc_shifta,
 "taufunc_BK9", _hoc_taufunc,
 0, 0
};
#define peakab peakab_BK9
#define peaka peaka_BK9
#define shiftab shiftab_BK9
#define shifta shifta_BK9
#define taufunc taufunc_BK9
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 BK9 C:/Scan/lib_mech/BK9.mod\n");
