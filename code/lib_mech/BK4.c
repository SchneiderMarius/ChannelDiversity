...
#define nrn_init _nrn_init__BK4
#define _nrn_initial _nrn_initial__BK4
#define nrn_cur _nrn_cur__BK4
#define _nrn_current _nrn_current__BK4
#define nrn_jacob _nrn_jacob__BK4
#define nrn_state _nrn_state__BK4
#define _net_receive _net_receive__BK4 
#define rates rates__BK4 
#define state state__BK4 
...
extern Memb_func* memb_func;
 ...
 "setdata_BK4", _hoc_setdata,
 "peakab_BK4", _hoc_peakab,
 "peaka_BK4", _hoc_peaka,
 "rates_BK4", _hoc_rates,
 "shiftab_BK4", _hoc_shiftab,
 "shifta_BK4", _hoc_shifta,
 "taufunc_BK4", _hoc_taufunc,
 0, 0
};
#define peakab peakab_BK4
#define peaka peaka_BK4
#define shiftab shiftab_BK4
#define shifta shifta_BK4
#define taufunc taufunc_BK4
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 BK4 C:/Scan/lib_mech/BK4.mod\n");
