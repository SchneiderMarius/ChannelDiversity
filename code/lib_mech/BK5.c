...
#define nrn_init _nrn_init__BK5
#define _nrn_initial _nrn_initial__BK5
#define nrn_cur _nrn_cur__BK5
#define _nrn_current _nrn_current__BK5
#define nrn_jacob _nrn_jacob__BK5
#define nrn_state _nrn_state__BK5
#define _net_receive _net_receive__BK5 
#define rates rates__BK5 
#define state state__BK5 
...
extern Memb_func* memb_func;
 ...
 "setdata_BK5", _hoc_setdata,
 "peakab_BK5", _hoc_peakab,
 "peaka_BK5", _hoc_peaka,
 "rates_BK5", _hoc_rates,
 "shiftab_BK5", _hoc_shiftab,
 "shifta_BK5", _hoc_shifta,
 "taufunc_BK5", _hoc_taufunc,
 0, 0
};
#define peakab peakab_BK5
#define peaka peaka_BK5
#define shiftab shiftab_BK5
#define shifta shifta_BK5
#define taufunc taufunc_BK5
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 BK5 C:/Scan/lib_mech/BK5.mod\n");
