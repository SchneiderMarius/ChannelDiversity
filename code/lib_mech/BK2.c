...
#define nrn_init _nrn_init__BK2
#define _nrn_initial _nrn_initial__BK2
#define nrn_cur _nrn_cur__BK2
#define _nrn_current _nrn_current__BK2
#define nrn_jacob _nrn_jacob__BK2
#define nrn_state _nrn_state__BK2
#define _net_receive _net_receive__BK2 
#define rates rates__BK2 
#define state state__BK2 
...
extern Memb_func* memb_func;
 ...
 "setdata_BK2", _hoc_setdata,
 "peakab_BK2", _hoc_peakab,
 "peaka_BK2", _hoc_peaka,
 "rates_BK2", _hoc_rates,
 "shiftab_BK2", _hoc_shiftab,
 "shifta_BK2", _hoc_shifta,
 "taufunc_BK2", _hoc_taufunc,
 0, 0
};
#define peakab peakab_BK2
#define peaka peaka_BK2
#define shiftab shiftab_BK2
#define shifta shifta_BK2
#define taufunc taufunc_BK2
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 BK2 C:/Scan/lib_mech/BK2.mod\n");
