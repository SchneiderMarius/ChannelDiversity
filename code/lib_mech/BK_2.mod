: Ca-dependent K channels (BK_2) - alphabeta4 and alpha
...
DERIVATIVE state {
	...
	acai = (ncai) / diff : instantaneous calcium concentration of N-type Ca channels for BK_2 activation modified by diffusion factor for nanodomains
