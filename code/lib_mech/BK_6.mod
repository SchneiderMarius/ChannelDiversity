: Ca-dependent K channels (BK_6) - alphabeta4 and alpha
...
DERIVATIVE state {
	...
	acai = (ncai) / diff : instantaneous calcium concentration of N-type Ca channels for BK_6 activation modified by diffusion factor for nanodomains
