...
#define nrn_init _nrn_init__BK15
#define _nrn_initial _nrn_initial__BK15
#define nrn_cur _nrn_cur__BK15
#define _nrn_current _nrn_current__BK15
#define nrn_jacob _nrn_jacob__BK15
#define nrn_state _nrn_state__BK15
#define _net_receive _net_receive__BK15 
#define rates rates__BK15 
#define state state__BK15 
...
extern Memb_func* memb_func;
 ...
 "setdata_BK15", _hoc_setdata,
 "peakab_BK15", _hoc_peakab,
 "peaka_BK15", _hoc_peaka,
 "rates_BK15", _hoc_rates,
 "shiftab_BK15", _hoc_shiftab,
 "shifta_BK15", _hoc_shifta,
 "taufunc_BK15", _hoc_taufunc,
 0, 0
};
#define peakab peakab_BK15
#define peaka peaka_BK15
#define shiftab shiftab_BK15
#define shifta shifta_BK15
#define taufunc taufunc_BK15
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 BK15 C:/Scan/lib_mech/BK15.mod\n");
