...
#define nrn_init _nrn_init__BK7
#define _nrn_initial _nrn_initial__BK7
#define nrn_cur _nrn_cur__BK7
#define _nrn_current _nrn_current__BK7
#define nrn_jacob _nrn_jacob__BK7
#define nrn_state _nrn_state__BK7
#define _net_receive _net_receive__BK7 
#define rates rates__BK7 
#define state state__BK7 
...
extern Memb_func* memb_func;
 ...
 "setdata_BK7", _hoc_setdata,
 "peakab_BK7", _hoc_peakab,
 "peaka_BK7", _hoc_peaka,
 "rates_BK7", _hoc_rates,
 "shiftab_BK7", _hoc_shiftab,
 "shifta_BK7", _hoc_shifta,
 "taufunc_BK7", _hoc_taufunc,
 0, 0
};
#define peakab peakab_BK7
#define peaka peaka_BK7
#define shiftab shiftab_BK7
#define shifta shifta_BK7
#define taufunc taufunc_BK7
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 BK7 C:/Scan/lib_mech/BK7.mod\n");
