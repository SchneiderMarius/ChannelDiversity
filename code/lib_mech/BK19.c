...
#define nrn_init _nrn_init__BK19
#define _nrn_initial _nrn_initial__BK19
#define nrn_cur _nrn_cur__BK19
#define _nrn_current _nrn_current__BK19
#define nrn_jacob _nrn_jacob__BK19
#define nrn_state _nrn_state__BK19
#define _net_receive _net_receive__BK19 
#define rates rates__BK19 
#define state state__BK19 
...
extern Memb_func* memb_func;
 ...
 "setdata_BK19", _hoc_setdata,
 "peakab_BK19", _hoc_peakab,
 "peaka_BK19", _hoc_peaka,
 "rates_BK19", _hoc_rates,
 "shiftab_BK19", _hoc_shiftab,
 "shifta_BK19", _hoc_shifta,
 "taufunc_BK19", _hoc_taufunc,
 0, 0
};
#define peakab peakab_BK19
#define peaka peaka_BK19
#define shiftab shiftab_BK19
#define shifta shifta_BK19
#define taufunc taufunc_BK19
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 BK19 C:/Scan/lib_mech/BK19.mod\n");
