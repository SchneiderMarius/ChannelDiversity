...
#define nrn_init _nrn_init__KrueppelAMPA
#define _nrn_initial _nrn_initial__KrueppelAMPA
#define nrn_cur _nrn_cur__KrueppelAMPA
#define _nrn_current _nrn_current__KrueppelAMPA
#define nrn_jacob _nrn_jacob__KrueppelAMPA
#define nrn_state _nrn_state__KrueppelAMPA
#define _net_receive _net_receive__KrueppelAMPA 
#define release release__KrueppelAMPA 
...
#define _f_exptable _f_exptable_KrueppelAMPA
#define exptable exptable_KrueppelAMPA
 extern double _f_exptable( double );
 extern double exptable( double );
 /* declare global and static user variables */
#define usetable usetable_KrueppelAMPA
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_KrueppelAMPA", 0, 1,
 0,0,0
};
 ...
 "usetable_KrueppelAMPA", &usetable_KrueppelAMPA,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 KrueppelAMPA C:/Scan/lib_mech/KrueppelAMPA.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("KrueppelAMPA", "cannot be used with CVODE"); return 0;}
...
{
 { error =  release();
 if(error){fprintf(stderr,"at line 59 in file KrueppelAMPA.mod:\n	SOLVE release\n"); nrn_complain(_p); abort_run(error);}
 }}}
