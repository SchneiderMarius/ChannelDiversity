...
#define nrn_init _nrn_init__BK14
#define _nrn_initial _nrn_initial__BK14
#define nrn_cur _nrn_cur__BK14
#define _nrn_current _nrn_current__BK14
#define nrn_jacob _nrn_jacob__BK14
#define nrn_state _nrn_state__BK14
#define _net_receive _net_receive__BK14 
#define rates rates__BK14 
#define state state__BK14 
...
extern Memb_func* memb_func;
 ...
 "setdata_BK14", _hoc_setdata,
 "peakab_BK14", _hoc_peakab,
 "peaka_BK14", _hoc_peaka,
 "rates_BK14", _hoc_rates,
 "shiftab_BK14", _hoc_shiftab,
 "shifta_BK14", _hoc_shifta,
 "taufunc_BK14", _hoc_taufunc,
 0, 0
};
#define peakab peakab_BK14
#define peaka peaka_BK14
#define shiftab shiftab_BK14
#define shifta shifta_BK14
#define taufunc taufunc_BK14
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 BK14 C:/Scan/lib_mech/BK14.mod\n");
