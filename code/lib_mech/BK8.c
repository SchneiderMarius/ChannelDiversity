...
#define nrn_init _nrn_init__BK8
#define _nrn_initial _nrn_initial__BK8
#define nrn_cur _nrn_cur__BK8
#define _nrn_current _nrn_current__BK8
#define nrn_jacob _nrn_jacob__BK8
#define nrn_state _nrn_state__BK8
#define _net_receive _net_receive__BK8 
#define rates rates__BK8 
#define state state__BK8 
...
extern Memb_func* memb_func;
 ...
 "setdata_BK8", _hoc_setdata,
 "peakab_BK8", _hoc_peakab,
 "peaka_BK8", _hoc_peaka,
 "rates_BK8", _hoc_rates,
 "shiftab_BK8", _hoc_shiftab,
 "shifta_BK8", _hoc_shifta,
 "taufunc_BK8", _hoc_taufunc,
 0, 0
};
#define peakab peakab_BK8
#define peaka peaka_BK8
#define shiftab shiftab_BK8
#define shifta shifta_BK8
#define taufunc taufunc_BK8
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 BK8 C:/Scan/lib_mech/BK8.mod\n");
