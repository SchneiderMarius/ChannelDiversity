...
#define nrn_init _nrn_init__BK11
#define _nrn_initial _nrn_initial__BK11
#define nrn_cur _nrn_cur__BK11
#define _nrn_current _nrn_current__BK11
#define nrn_jacob _nrn_jacob__BK11
#define nrn_state _nrn_state__BK11
#define _net_receive _net_receive__BK11 
#define rates rates__BK11 
#define state state__BK11 
...
extern Memb_func* memb_func;
 ...
 "setdata_BK11", _hoc_setdata,
 "peakab_BK11", _hoc_peakab,
 "peaka_BK11", _hoc_peaka,
 "rates_BK11", _hoc_rates,
 "shiftab_BK11", _hoc_shiftab,
 "shifta_BK11", _hoc_shifta,
 "taufunc_BK11", _hoc_taufunc,
 0, 0
};
#define peakab peakab_BK11
#define peaka peaka_BK11
#define shiftab shiftab_BK11
#define shifta shifta_BK11
#define taufunc taufunc_BK11
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 BK11 C:/Scan/lib_mech/BK11.mod\n");
