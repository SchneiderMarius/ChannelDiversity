...
#define nrn_init _nrn_init__BK17
#define _nrn_initial _nrn_initial__BK17
#define nrn_cur _nrn_cur__BK17
#define _nrn_current _nrn_current__BK17
#define nrn_jacob _nrn_jacob__BK17
#define nrn_state _nrn_state__BK17
#define _net_receive _net_receive__BK17 
#define rates rates__BK17 
#define state state__BK17 
...
extern Memb_func* memb_func;
 ...
 "setdata_BK17", _hoc_setdata,
 "peakab_BK17", _hoc_peakab,
 "peaka_BK17", _hoc_peaka,
 "rates_BK17", _hoc_rates,
 "shiftab_BK17", _hoc_shiftab,
 "shifta_BK17", _hoc_shifta,
 "taufunc_BK17", _hoc_taufunc,
 0, 0
};
#define peakab peakab_BK17
#define peaka peaka_BK17
#define shiftab shiftab_BK17
#define shifta shifta_BK17
#define taufunc taufunc_BK17
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 BK17 C:/Scan/lib_mech/BK17.mod\n");
