...
#define nrn_init _nrn_init__BK_6
#define _nrn_initial _nrn_initial__BK_6
#define nrn_cur _nrn_cur__BK_6
#define _nrn_current _nrn_current__BK_6
#define nrn_jacob _nrn_jacob__BK_6
#define nrn_state _nrn_state__BK_6
#define _net_receive _net_receive__BK_6 
#define rates rates__BK_6 
#define state state__BK_6 
...
extern Memb_func* memb_func;
 ...
 "setdata_BK_6", _hoc_setdata,
 "peakab_BK_6", _hoc_peakab,
 "peaka_BK_6", _hoc_peaka,
 "rates_BK_6", _hoc_rates,
 "shiftab_BK_6", _hoc_shiftab,
 "shifta_BK_6", _hoc_shifta,
 "taufunc_BK_6", _hoc_taufunc,
 0, 0
};
#define peakab peakab_BK_6
#define peaka peaka_BK_6
#define shiftab shiftab_BK_6
#define shifta shifta_BK_6
#define taufunc taufunc_BK_6
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 BK_6 C:/Scan/lib_mech/BK_6.mod\n");
